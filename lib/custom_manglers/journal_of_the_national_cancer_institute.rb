...
module ECMangle
  ...
  class JournalOfTheNationalCancerInstitute < ECMangle::DefaultMangler
    def initialize
      @title = 'Journal of the National Cancer Institute'
      @ocns = [1_064_763, 36_542_869, 173_847_259, 21_986_096]
      super
    ...
    def parse_ec(ec_string)
      ...
      unless matchdata.nil?
        ...
        if ec['volume'] && !ec['year'] && (ec['volume'].to_i >= 80)
          ec['year'] = volume_to_year ec['volume']
        end
        if ec['year'] && !ec['volume'] && (ec['year'].to_i >= 1988)
    ...
    def year_to_volume(year)
      ...
      # correspondence
      (80 + (year.to_i - 1988)).to_s if year.to_i >= 1988
    end
