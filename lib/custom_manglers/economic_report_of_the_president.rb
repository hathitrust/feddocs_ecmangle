...
module ECMangle
  ...
  # monographs.
  class EconomicReportOfThePresident < ECMangle::DefaultMangler
    class << self; attr_accessor :parts end
    @parts = Hash.new { |hash, key| hash[key] = [] }

    def initialize
      @title = 'Economic Report of the President'
      @sudoc_stems = ['Y 4.EC 7:EC 7/2/']
      @ocns = [3_160_302, 8_762_269, 8_762_232]
      super
    ...
    def parse_ec(ec_string)
      ...
      ec_string = ec_string.sub(/ ?C\. 1 ?/, '').sub(/-$/, '')
